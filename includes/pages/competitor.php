...
function leseo_competitor_page() {
	?>
	<div class="container-fluid p-4 leseo-coming-soon">
		...
		<div class="leseo-coming-soon-overlay">
			<div class="text-center">
				...
				<h2 class="h4 text-body-secondary mb-2"><?php esc_html_e( 'Competitor Analysis', 'leseo-ai' ); ?></h2>
				<p class="text-body-secondary mb-0"><?php esc_html_e( 'Coming soon. Track competitor blogs and find content gaps automatically.', 'leseo-ai' ); ?></p>
			</div>
		</div>
