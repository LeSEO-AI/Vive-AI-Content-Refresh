...
function leseo_create_page() {
	...
	<div class="container-fluid p-4">
		...
		<form id="leseo-create-form">

			<!-- Topic hero -->
			<div class="mb-4">
				<label for="leseo-topic" class="form-label h5">What do you want to write about?</label>
				<textarea id="leseo-topic" name="topic" class="form-control form-control-lg" rows="2"
			...
			<div class="row g-3 align-items-end mb-4">
				<div class="col-md-4">
					<label for="leseo-keywords" class="form-label small fw-medium">Target Keywords</label>
					<input type="text" id="leseo-keywords" name="keywords" class="form-control"
						   placeholder="wordpress seo, site speed, core web vitals" />
				</div>
				<div class="col-md-3">
					<label for="leseo-tone" class="form-label small fw-medium">Tone</label>
					<select id="leseo-tone" name="tone" class="form-select">
				...
				<div class="col-md-5 d-flex gap-2">
					<a href="?page=leseo-ai-settings" class="btn btn-outline-secondary btn-lg">
						Settings &amp; Persona
					</a>
		...
		<!-- Output -->
		<div id="leseo-create-output" class="border rounded-3 p-4 bg-light">
